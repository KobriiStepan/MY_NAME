...
const test3 = 'Щука риба чай напиток яма земля шапка хуйня';
...
console.log(zamm ((zamm (test3.toLowerCase(), testarr1, testarr2) ) , testarr2, testarr1)); //транслит с англиского и назад
